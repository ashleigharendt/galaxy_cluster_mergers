...
#         mem = CustomMemoryCallback()
    ...
    def output_results(self):
        ...
        # saved model
        fpr, tpr, thresholds = roc_curve(self.y_te, y_prob)
        auc = roc_auc_score(self.y_te, y_prob)
        precision = precision_score(self.y_te, y_pred)
        recall = recall_score(self.y_te, y_pred)
    ...
    def save_model(self, loc, model_name):
        
        model_json = self.model.to_json()
        
        with open(loc + '/' + model_name + '.json', "w") as json_file:
